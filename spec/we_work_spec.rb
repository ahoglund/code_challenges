...
CSV
  ...
  context "Given a month and a year of 2000-01" do
    it "should have a revenue: $0.00" do
      @calculator = RevenueAndCapacityCalculator.new(date: "2000-01", data: @csv)
      expect(@calculator.total_revenue).to eq "$0.00"
    end
  ...
  context "Given a month and a year of 2018-01" do
    ...
    it "should have a revenue: $77,000.00" do
      @calculator = RevenueAndCapacityCalculator.new(date: "2018-01", data: @csv)
      expect(@calculator.total_revenue).to eq "$77,000.00"
    end
  ...
  context "running #prorated_price" do
    it "should return $750 for 2, 1500, 2014-05-01, 2014-05-15" do
    end
  end
